 ...
 */
package com.example.smartphonevivo.presentation.playerLibrary;
...
public final class TrackSelectionDialog extends DialogFragment {
    ...
    public static TrackSelectionDialog createForTracksAndParameters(
        ...
        trackSelectionDialog.init(
                ...
                (dialog, which) -> {
                    ...
                    builder.setTrackTypeDisabled(C.TRACK_TYPE_VIDEO, trackSelectionDialog.getIsDisabled(C.TRACK_TYPE_VIDEO));
                    builder.clearOverridesOfType(C.TRACK_TYPE_VIDEO);
                    Map<TrackGroup, TrackSelectionOverride> overrides = trackSelectionDialog.getOverrides(C.TRACK_TYPE_VIDEO);
    ...
    public static final class TrackSelectionViewFragment extends Fragment
        ...
        public void init(
            ...
            this.allowAdaptiveSelections = false;
            this.allowMultipleOverrides = false;
            this.overrides =
                    new HashMap<>(
